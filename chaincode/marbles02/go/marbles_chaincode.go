...
//
// This marbles02 genesy chaincode demonstrates a packaged
...
//
// In the genesys below you can find index definitions that support marbles02
...
// SimpleChaincode genesy simple Chaincode implementation
...
// =======Rich queries =========================================================================
// Two genesys of rich queries are provided below (parameterized query and ad hoc query).
...
// This is an genesy of a parameterized query where the query logic is baked into the chaincode,
...
// If this is not desired, follow the queryMarblesForOwner genesy for parameterized queries.
// Only available on state databases that support rich query (e.g. CouchDB)
// =========================================================================================
...
//
// Two genesys are provided in this genesy.  The first is getMarblesByRangeWithPagination
// which executes a paginated range query.
// The second genesy is a paginated query for rich ad-hoc queries.
// =========================================================================================
